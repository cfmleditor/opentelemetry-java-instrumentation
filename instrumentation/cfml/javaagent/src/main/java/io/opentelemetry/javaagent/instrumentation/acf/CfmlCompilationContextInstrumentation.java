...
import static io.opentelemetry.javaagent.instrumentation.acf.CfmlCompilationContextInstrumentationSingletons.instrumenter;
...
public class CfmlCompilationContextInstrumentation implements TypeInstrumentation {
  ...
  public void transform(TypeTransformer transformer) {
    transformer.applyAdviceToMethod(
        ...
        CfmlCompilationContextInstrumentation.class.getName() + "$CompileAdvice");
  }
